...
| Tag | Commit | Purpose |
| --- | --- | --- |
| [`v0.1.0`](https://github.com/kazuru-chidumbwe/identity-trust-lab/releases/tag/v0.1.0) | `77fcb8e` | First SemVer release (same tree as Case 1 partial) |
...
```bash
git checkout v0.1.0   # or case1-partial-2026-07
...
- Case 1 measurement cite → `case1-partial-2026-07` (same tree as `v0.1.0`).
